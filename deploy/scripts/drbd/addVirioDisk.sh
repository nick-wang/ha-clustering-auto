...
function usage()
{
  ...
  # ./addVirioDisk.sh /var/lib/jenkins-work/nwang/deploy-cluster-v232/10/cluster_conf 3 /mnt/vm/sles_nick 400M
  ...
  echo "For example:"
  echo "  ./addVirioDisk.sh /var/lib/jenkins-work/nwang/deploy-cluster-v232/10/cluster_conf 3 /mnt/vm/sles_nick 400M"
}
